...
use App\Exceptions\UnknownPathException;
...
class Application
{
    ...
    private function setExceptionHandler($header)
    {
    ...
    public function handle(Request $request)
    {
        ...
        $this->setExceptionHandler($request->getServerParams());
        ...
        throw new UnknownPathException("Ii bai");
    ...
    private function filterRoute($route)
    {
        ...
        $parameters = isset($route['parameters']) ? $route['parameters'] : null;
